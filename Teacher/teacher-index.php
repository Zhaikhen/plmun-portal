		...
		<main role="main" class="col-xl-10 col-lg-9 col-md-8 ml-sm-auto px-md-4 main-background mb-2 w-100">
			<div class="sub-main">
				<div class="text-center d-flex flex-wrap flex-md-nowrap pt-3 pb-2 mb-3 text-white admin-dashboard pl-3">
					<h4 class="">Teacher: <?php $roll_no=$_SESSION['LoginTeacher'];
						...
						<div>
							<section class="mt-3">
								<div class="btn btn-block table-three text-light d-flex">
									<span class="font-weight-bold"><i class="fa fa-money mr-3" aria-hidden="true"></i> Salary History</span>
						...
						<div>
							<section class="mt-3">
								<div class="btn btn-block table-one text-light d-flex">
									<span class="font-weight-bold"><i class="fa fa-bell-o mr-3" aria-hidden="true"></i> REMINDERS</span>
								...
								<div class="collapse show mt-2" id="collapsethree">
									<table class="w-100 table-elements table-one-tr"cellpadding="2">
										<tr>
											<td>Time-In and Time-out accurately</td>
										</tr>
										<tr>
											<td>Read and Reflect upon the Memo</td>
										</tr>
										<tr>
											<td>Respect other's personal space</td>
										</tr>
										<tr>
											<td>No Loud noises in the Office</td>
										</tr>
										<tr>
											<td>Wear appropriate Department Shirt and Uniform</td>
										</tr>
									</table>
								</div>
							</section>
