...
// *****************************************Images upload code end here********************************************************** 
 		...
 		$query="Insert into teacher_info(first_name,middle_name,last_name,email,phone_no,profile_image,teacher_status,application_status,dob,gender,permanent_address,current_address,place_of_birth,hire_date)values('$first_name','$middle_name','$last_name','$email','$phone_no','$profile_image','$teacher_status','$application_status','$dob','$gender','$permanent_address','$current_address','$place_of_birth','$date')";
 		$run=mysqli_query($con, $query);
 		if ($run) {
 			echo "New Faculty Member registered and ";
 		}
 		else {
 		...
 		if ($run2) {
 			echo "User account is Subject for ACTIVATION!!";
 		}
 		else {
 			echo "Your Data has not been submitted";
 		}
		...
		<main role="main" class="col-xl-10 col-lg-9 col-md-8 ml-sm-auto px-md-4 mb-2 w-100">
			<div class="sub-main">
				<div class="text-center d-flex flex-wrap flex-md-nowrap pt-3 pb-2 mb-3 text-white admin-dashboard pl-3">
					<div class="d-flex">
						<h4 class="mr-5">FACULTY ACCOUNT MANAGEMENT </h4>
						<button type="button" class="btn btn-success ml-5" data-toggle="modal" data-target=".bd-example-modal-lg">Add Professor</button>
						&nbsp;
							...
							<div class="modal-dialog modal-lg">
								<div class="modal-content">
									<div class="modal-header bg-info text-white">
										<h4 class="modal-title text-center">ADD NEW FACULTY MEMBER</h4>
									</div>
									<div class="modal-body">
										<form action="teacher.php" method="post" enctype="multipart/form-data">
											...
											<div class="row">
												<div class="col-md-4">
													<div class="formp">
														<label for="exampleInputPassword1">Faculty Email:</label>
												...
												<div class="col-md-4">
													<div class="formp">
														<label for="exampleInputPassword1">Faculty Profile Photo</label>
					...
					<div class="col-md-12 ml-2">
						<section class="mt-3">
							<div class="row">
								<div class="col-md-3 offset-9 pt-5 mb-2">
									...
									<div class="modal-dialog modal-lg">
											<div class="modal-content">
												<div class="modal-header bg-info text-white">
													<h4 class="modal-title text-center">ASSIGN SUBJECT UNITS</h4>
												</div>
												<div class="modal-body">
													<form action="teacher.php" method="POST" enctype="multipart/form-data">
														<div class="row mt-3">
														...
														<div class="row">
															<div class="col-md-6">
																<div class="form-group">
																	<label for="exampleInputPassword1">Enter Faculty Id:</label>
							...
							<tr class="table-tr-head table-three text-white">
											<td colspan="8" class="text-center text-white"><h4>FACULTY LIST</h4></td>
</td>
										</tr>
								<tr class="table-tr-head table-three text-white">
									<th>Faculty ID</th>
								...
								while($row=mysqli_fetch_array($run)) {
									...
									echo	"<td width='170'><a class='btn btn-primary' href=../Admin/display-teacher.php?teacher_id=".$row['teacher_id'].">Profile</a> <a class='btn btn-danger' href=delete-function.php?email=".$row['email'].">Delete</a></td>";
									echo "</tr>";
								}
								?>
							</table>				
