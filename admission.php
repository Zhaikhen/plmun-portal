...
<head>
	...
	<link rel="shortcut icon" type="image/x-icon" href="Images/plmun_logo.png">
...
<body>
	...
	<div class="container-fluid">
		...
		<div class="row m-3">
			<div class="col-md-12">
				<form action="/CMS/Admin/student.php" method="POST" enctype="multipart/form-data">
					<div class="row mt-3">
						<div class="col-md-4">
		...
		<h4 class="p-3 text-center">Download, print and accomplish the Admission Letter from the button below and add to your compiled documents folder.</h4>
	<div class="container">
<a href="$baseUrl/../Files/sample.pdf" download>
<button class="button center"><i class="fa fa-download"></i> Download</button> </a>
									</div>
