		...
		<main role="main" class="col-xl-10 col-lg-9 col-md-8 ml-sm-auto px-md-4 w-100">
			<div class="sub-main">
				<div class="text-center d-flex flex-wrap flex-md-nowrap pt-3 pb-2 mb-3 text-white admin-dashboard pl-3">
					<div class="d-flex">
						<h4 class="mr-5">FACULTY SALARY MAMAGEMENT </h4>
						<button type="button" class="btn btn-success ml-5 mr-5" data-toggle="modal" data-target=".bd-example-modal-lg">Add Salary Scale</button>
															...
															<div class="row mt-3">
																<div class="col-md-6 pr-5">
																	<div class="form-group">
																		...
																		<input type="text" name="teacher_id" class="form-control" placeholder="Enter Faculty ID">
																	</div>
																</div>
																<div class="col-md-6 pr-5">
																	<div class="form-group">
								...
								<div class="col-md-12">
									<table class="w-100 table-elements table-three-tr" cellpadding="3">
										<tr class="table-tr-head table-three text-white">
											<td colspan="8" class=" text-center text-white"><h4>ALL FACULTY SALARY HISTORY</h4></td>
										</tr>
