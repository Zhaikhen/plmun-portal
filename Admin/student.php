...
// *****************************************Images upload code end here********************************************************** 
 		...
 		$query="Insert into student_info(first_name,middle_name,last_name,father_name,email,mobile_no,course_code,profile_image,prospectus_issued,prospectus_amount,applicant_status,application_status,dob,gender,permanent_address,current_address,place_of_birth)values('$first_name','$middle_name','$last_name','$father_name','$email','$mobile_no','$course_code','$profile_image','$prospectus_issued','$prospectus_amount','$applicant_status','$application_status','$dob','$gender','$permanent_address','$current_address','$place_of_birth')";
		 
		 $run=mysqli_query($con, $query);
 		if ($run) {
			$last_id = mysqli_insert_id($con);
 			echo "Student No: [" . $last_id. "] is REGISTERED and";
 		}
 		else {
 			echo "Your Data has NOT been submitted and";
 		}
 		$query2="insert into login(user_id,Password,Role)values('$last_id','$password','$role')";
 		$run2=mysqli_query($con, $query2);
 		if ($run2) {
 			echo " the User Account is subject for ACTIVATION!!";
 		}
 		else {
 			echo " User Account NOT Added!!";//
 		}
							        ...
							        <form action="student.php" method="POST" enctype="multipart/form-data">
										<div class="row mt-3">
								  		...
								  		<div class="row">
											...
											<div class="col-md-4">
												<div class="form-group">
												    <label for="exampleInputPassword1">Student Profile Photo:</label>
								  		...
								  		<div class="row">
											<div class="col-md-4">
											    <div class="form-group">
											        <label for="exampleInputEmail1">Scholarship Issued: </label>
											...
											<div class="col-md-4">
												<div class="form-group">
												    <label for="exampleInputPassword1">Reciceved Scholarship Cash??:</label>
					...
					<div class="col-md-12 ml-2">
						<section class="mt-3">
							<div class="row">
								<div class="col-md-6">
									<form action="search_student.php" method="post"> 
										<div class="form-group">
											<label for="exampleInputPassword1"><h5>Search Student Information:</h5></label>
											<div class="d-flex">
												<input type="text" name="search" id="search" class="form form-control" placeholder="Enter Student Number">
								...
								<div class="col-md-12 pt-5 mb-2">
									<!-- Large modal -->
									<button type="button" class="btn btn-primary ml-auto" data-toggle="modal" data-target=".bd-example-modal-lg1">ASSIGN SINGLE SUBJECTS</button>
									<a class="btn btn-success" href="asign-single-student-subjects.php"> ASSIGN ALL SUBJECTS</a>
									<div class="modal fade bd-example-modal-lg1" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
										<div class="modal-dialog modal-lg">
												<div class="modal-content">
													<div class="modal-header bg-info text-white">
														<h4 class="modal-title text-center">ASSIGN SINGLE SUBJECTS</h4>
													</div>
													<div class="modal-body">
														<form action="student.php" method="POST" enctype="multipart/form-data">
															<div class="row mt-3">
															...
															<div class="row">
																<div class="col-md-6">
																	<div class="form-group">
																		<label for="exampleInputPassword1">Enter Student No:*</label>
															...
															<div class="modal-footer">
																<input type="submit" class="btn btn-primary" name="btn_save2" value="Assign">
																<button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
															</div>
														</form>
													</div>
							...
							<table class="w-100 table-elements mb-5 table-three-tr text-center" cellpadding="10">
								...
								<?php 
								$query="select first_name,middle_name,admission_date,last_name,current_address,roll_no,profile_image,course_code from student_info";
								$run=mysqli_query($con,$query);
								while($row=mysqli_fetch_array($run)) {?>
									<tr>
