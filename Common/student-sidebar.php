				...
				<div class="sidebar-header">
					<div class="nav-item">
						<a class="nav-link text-white" href="../student/student-index.php">
							...
							<i class="fa fa-home mr-2" aria-hidden="true"></i> --STUDENT-- 
						</a>
					</div>
				</div>
				<ul class="nav flex-column">
					<li class="nav-item">
						<a class="nav-link" href="../admin/display-student-student.php">
					...
					<li class="nav-item">
						...
						<span data-feather="file"></span>
						<i class="fa fa-info-circle mr-2" aria-hidden="true"></i> Update Information
						</a>
					</li>
					<li class="nav-item">
						<a class="nav-link" href="../student/student-result.php">
						<span data-feather="shopping-cart"></span>
						<i class="fa fa-th-list mr-2" aria-hidden="true"></i> Academic Results
						</a>
					</li>
					<li class="nav-item">
						<a class="nav-link" href="student-documents.php">
						<span data-feather="shopping-cart"></span>
						<i class="fas fa-file-signature mr-2" aria-hidden="true"></i> Document Codes
						</a>
					</li>
					<li class="nav-item">
						<a class="nav-link" href="../student/student-fee.php">
						<span data-feather="users"></span>
						<i class="fa fa-credit-card-alt mr-2" aria-hidden="true"></i> Payments
						</a>
					</li>
					<li class="nav-item">
