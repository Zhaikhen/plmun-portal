...
<?php 
 	...
 	if (isset($_POST['btn_save'])) {
 		...
 		$query="insert into time_table(course_code,semester,timing_from,timing_to,day_id,subject_code,room_no)values('$course_code','$semester','$timing_from','$timing_to','$day_id','$subject_code','$room_no')";
...
<?php 
 	...
 	if (isset($_POST['btn_update'])) {
 		...
 		$query1="update time_table set course_code='$course_code',semester='$semester',timing_from='$timing_from',timing_to='$timing_to',day_id='$day_id',subject_code='$subject_code',room_no='$room_no' where subject_code='$subject_code'";
		...
		<main role="main" class="col-xl-10 col-lg-9 col-md-8 ml-sm-auto px-md-4 mb-2 w-100">
			<div class="sub-main">
				<div class="text-center d-flex flex-wrap flex-md-nowrap pt-3 pb-2 mb-3 text-white admin-dashboard pl-3">
					<div class="d-flex">
						<h4 class="mr-5">SCHEDULE MANAGEMENT </h4>
															...
															<div class="row">
																<div class="col-md-6">
																	<div class="form-group">
																		...
																		<select class="browser-default custom-select" name="day_id">
								...
								<div class="col-md-12">
									<table class="w-100 table-elements table-three-tr" cellpadding="3">
										<tr class="table-tr-head table-three text-white">
											<td colspan="8" class="text-center text-white"><h4>AVAILABLE SCHEDULES</h4><button type="button" class="btn btn-primary" data-toggle="modal" data-target=".bd-example-modal-lg1"><i class="fas fa-edit"></i></td>
										...
										<?php  
											...
											while($row=mysqli_fetch_array($run)) {
												...
												echo '<td><a href="time-table.php?delete='.$row['id'].'" class="btn btn-danger"><i class="fas fa-trash"><i/></a></td>';
												echo "</tr>";
											}
										?>
									</table>
