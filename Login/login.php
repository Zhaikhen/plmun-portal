...
<html lang="en">
	<head>
		<title>PLMUN PORTAL LOGIN</title>
	...
	<body class="login-background">
        ...
        <div class="login-div mt-3 rounded">
            <div class="logo-div text-center">
                <img src="../Images/plmun_logo.png" alt="plmun_logo" class="align-items-center" width="100" height="100">
            </div>
            <div class="login-padding">
                ...
                <form class="p-1" action="login.php" method="POST">
                    <div class="form-group">
                        ...
                        <input type="text" name="email" placeholder="Enter User No. or Email" class="form-control" required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group text-center mb-3 mt-4">
                        ...
                        <a href="../index.php" class="btn btn-white pl-5 pr-5">HOME</a>
                    </div>
                </form>
            </div>
        </div>
