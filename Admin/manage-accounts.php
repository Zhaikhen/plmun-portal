									...
									<div class="row">
										<div class="col-md-6">
											<div class="form-group">
												<label><strong>Faculty ID or Student Number</strong></label>
												<input type="text" name="user_id" class="form-control" required placeholder="Enter Faculty ID or Student Number HERE">
											</div>
										</div>
										<div class="col-md-6">
											<div class="form-group">
												<label><strong>Change Account Status:</strong></label>
												<select name="account" class="form-control">
													<option selected disabled hidden>--Set Account Status--</option>
