		...
		<main role="main" class="col-xl-10 col-lg-9 col-md-8 ml-sm-auto px-md-4 main-background mb-2 w-100">
			<div class="sub-main">
				<div class="text-center d-flex flex-wrap flex-md-nowrap pt-3 pb-2 mb-3 text-white admin-dashboard pl-3">
					<h4 class="">ASSIGNED TEACHING SCHEDULE</h4>
				</div>
				<div class="row">
					<div class="col-md-12">
						<section class="border mt-3">
							<table border="1" class="w-100 table-striped table-dark"cellpadding="5" >
								...
								$query="select tc.teacher_id,tc.course_code,tc.subject_code,tc.semester,tc.total_classes,tt.room_no,tt.timing_from,tt.day,tt.timing_to,weekdays.day_name from teacher_courses tc inner join time_table tt on tc.subject_code=tt.subject_code inner join weekdays on tt.day=weekdays.day_id where teacher_id='$teacher_id'";
								...
								while($row=mysqli_fetch_array($run)) {
									...
									echo "<td>".$row["timing_from"]."-".$row["timing_to"]."</td>";
