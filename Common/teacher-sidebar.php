			...
			<div class="col-xl-2 col-lg-3 col-md-4 sidebar position-fixed border-right">
        		<div class="sidebar-header">
					...
					<span class="home"></span>
						<i class="fa fa-home mr-2" aria-hidden="true"></i> --FACULTY--
					</a>
				</div>
				<ul class="nav flex-column">
					<li class="nav-item">
						<a class="nav-link" href="../admin/display-teacher-teacher.php">
					...
					<li class="nav-item">
						...
						<i class="fa fa-address-book mr-2" aria-hidden="true"></i> My Schedule
						</a>
					</li>
					<li class="nav-item">
