							...
							<div class="row mt-3">
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<input type="text" name="roll_no" class="form-control" placeholder="Enter Student No" required>
									</div>
								</div>
								<div class="col-md-4">
					...
					<div class="col-md-12 ml-2">
						<section class="border mt-3">
							<table class="w-100 table-elements table-three-tr" cellpadding="3">
								...
								$count=0;
									...
									?>
										...
										<tr>
											...
											<td><input type="text" name="obtain_marks[]" placeholder="Enter Student's Grade Here" class="form-control" required></td>
								...
								&nbsp;
										<a href="class-result.php" class="btn btn-danger">CLOSE</a>
